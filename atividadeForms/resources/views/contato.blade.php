                ...
                <div class="flex flex-wrap items-center justify-between ">
                    <div class="w-50 lg:w-1/2 box">
                        ...
                        <p class="t text-lg text-gray-300 mb-8 will-change-transform	box">
                            Use esta página para enviar suas mensagens de contato. Você pode nos enviar uma mensagem para nós. Estamos aqui para ajudar!
                        </p>
                        
                        <a href="{{ route('contato') }}" class="group bg-purple-500 hover:bg-purple-800 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out">
                            Enviar Mensagem
                        </a>
